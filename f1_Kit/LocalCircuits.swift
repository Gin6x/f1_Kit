...
struct LocalCircuits {
    
    let displayCircuitName = ["bahrain", "saudi arabia", "australia", "azerbaijan", "us miami", "monaco", "spain",
    ...
    let image = ["bahrain", "jeddah", "albert_Park", "baku_City", "miami", "monaco", "barcelona", "gilles_Villeneuve", "redBull_Ring",
                 "silverstone", "hungaroring", "spa", "zandvoort", "monza", "singapore", "japanese", "losail", "unitied_State",
                 "mexico", "brazil", "las_Vegas", "abu_dhabi"]
}
